...
function Hyundai() {
  ...
  return (
    ...
    <div className="container">
      <div>
        <h1 className="text-white" style={{ colour: "white" }}>Hyundai New Kona</h1>
      </div>
      <div className="row">
        <div className="col-md-4">
          <div className="card4" style={{ background: "#9acef3" }}>
            <div className="image4"><span className="text"><img src='https://www.team-bhp.com/sites/default/files/styles/check_extra_large_for_review/public/2022-Hyundai-Creta-Header-2.jpg' /></span></div>
