    ...
    return (
        <>
            <div className="container">
                <div>
                    <h1 className="text-white" style={{ colour: "white" }}>Ferrari</h1>
                </div>
                <div className="row" >
                    <div className="col-md-4" >
                        <div>
                            <div className="card4" style={{ background: "#9acef3" }}>
                                <div className="image4"><span className="text"><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStm5sdFcHit6YrX9cXnZ1LagpoCuxKAd8erA&usqp=CAU' /></span></div>
