...
function Mercedescar() {
  ...
  return (
    ...
    <div className="container">
      <div>
        <h1 className="text-white" style={{ colour: "white" }}>Mercedescar</h1>
      </div>
      <div className="row">
        <div className="col-md-4">
          <div className="card4" style={{ background: "#9acef3" }}>
            <div className="image4"><span className="text"><img src='https://wallpaperaccess.com/full/3149102.jpg' /></span></div>
            <span className="title">Mercedescar</span>
