...
function Autocar() {
  ...
  return (
    ...
    <div className="container">
      <div>
        <h1 className="text-white" style={{ colour: "white" }}>Auto Car</h1>
      </div>
      <div className="row">
        <div className="col-md-4">
          <div className="card4" style={{ background: "#9acef3" }}>
            <div className="image4"><span className="text"><img src='https://www.autocar.co.uk/sites/autocar.co.uk/files/styles/body-image/public/mclaren-720s_0.jpg?itok=wZbSZ3FZ'/></span></div>
