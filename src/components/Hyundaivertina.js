...
function Hyundaivertina() {
  ...
  return (
    ...
    <div className="container">
      <div>
        <h1 className="text-white" style={{ colour: "white" }}>Hyundai Vertina</h1>
      </div>
      <div className="row">
        <div className="col-md-4">
          <div className="card4" style={{ background: "#9acef3" }}>
            <div className="image4"><span className="text"><img src='https://stimg.cardekho.com/images/carexteriorimages/930x620/Hyundai/Verna/8703/1679389180298/front-left-side-47.jpg'  /></span></div>
            <span className="title">Hyundai Vertina</span>
