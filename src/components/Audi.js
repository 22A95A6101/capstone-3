...
function Audi() {
  ...
  return (
    ...
    <div className="container">
      <div>
        <h1 className="text-white" style={{ colour: "white" }}>Audi</h1>
      </div>
      <div className="row">
        <div className="col-md-4">
          <div className="card4" style={{ background: "#9acef3" }}>
            <div className="image4"><span className="text"><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQt_uQ9OwStPbAJ9URXIAoOnOUxJ3y7F8ZMhw&usqp=CAU' /></span></div>
